...
public class State extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"State\",\"namespace\":\"utilities\",\"doc\":\"A list of states in the United States of America.\",\"fields\":[{\"name\":\"name\",\"type\":\"string\",\"doc\":\"The common name of the state.\"},{\"name\":\"post_abbr\",\"type\":\"string\",\"doc\":\"The postal code abbreviation of the state.\"}]}");
  ...
  private CharSequence post_abbr;
   ...
   */
  public State(CharSequence name, CharSequence post_abbr) {
    this.name = name;
  ...
  public void put(int field$, Object value$) {
    ...
    case 1: post_abbr = (CharSequence)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<State>
    ...
    public State build() {
      try {
        ...
        record.post_abbr = fieldSetFlags()[1] ? this.post_abbr : (CharSequence) defaultValue(fields()[1]);
        return record;
