...
Feature: GCS source - Verification of GCS to GCS Additional Tests successful
  ...
  @GCS_AVRO_FILE @GCS_SINK_TEST @EXISTING_GCS_CONNECTION @GCS_Source_Required
  ...
  @GCS_CSV @GCS_SINK_TEST @EXISTING_GCS_CONNECTION @GCS_Source_Required
  ...
  @GCS_MULTIPLE_FILES_TEST @GCS_SINK_TEST @EXISTING_GCS_CONNECTION @GCS_Source_Required
  ...
  @GCS_MULTIPLE_FILES_TEST @GCS_SINK_TEST @GCS_Source_Required
  ...
  @GCS_MULTIPLE_FILES_REGEX_TEST @GCS_SINK_TEST @EXISTING_GCS_CONNECTION @GCS_Source_Required
  ...
  @GCS_MULTIPLE_FILES_REGEX_TEST @GCS_SINK_TEST @GCS_Source_Required
